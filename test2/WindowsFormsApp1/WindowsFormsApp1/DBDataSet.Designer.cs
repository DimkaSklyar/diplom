...
namespace WindowsFormsApp1 {
    ...
    public partial class DBDataSet : global::System.Data.DataSet {
        ...
        public partial class Таблица1DataTable : global::System.Data.TypedTableBase<Таблица1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public Таблица1Row AddТаблица1Row(string Наименование) {
...
namespace WindowsFormsApp1.DBDataSetTableAdapters {
    ...
    public partial class Таблица1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Таблица1` WHERE ((`Код` = ?) AND ((? = 1 AND `Наименование` IS NULL)" +
                " OR (`Наименование` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Таблица1` (`Наименование`) VALUES (?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Таблица1` SET `Наименование` = ? WHERE ((`Код` = ?) AND ((? = 1 AND `Наим" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `Код`, `Наименование` FROM `Таблица1`";
        ...
        public virtual int Fill(DBDataSet.Таблица1DataTable dataTable) {
        ...
        public virtual DBDataSet.Таблица1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DBDataSet.Таблица1DataTable dataTable = new DBDataSet.Таблица1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DBDataSet.Таблица1DataTable dataTable) {
